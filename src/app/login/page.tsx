...
export default function Page() {
  ...
  async function handleSubmit(event: SubmitEvent<HTMLFormElement>) {
    ...
    setMessage("");
    if (!password) { setMessage("パスワードを入力してください。"); return; }
    ...
    try {
      ...
      if (!response.ok) { setMessage(result.message ?? "ログインできませんでした。"); return; }
      router.push("/");
  ...
  return (
    <main id="main-content" className="grid min-h-dvh px-5 py-6 lg:grid-cols-[.8fr_1.2fr]">
